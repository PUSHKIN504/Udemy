...
import 'package:udemy_proyect/models/lesson_fin.dart';
import 'package:udemy_proyect/widgets/custom_video_player.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
// import 'package:video_player/video_player.dart';
import '../widgets/lesson_card_fin.dart';

class DetailsScreenFin extends StatefulWidget {
  final String title;
  // ignore: use_super_parameters
  const DetailsScreenFin({
    Key? key,
    required this.title,
  }) : super(key: key);
  ...
  _DetailsScreenFinState createState() => _DetailsScreenFinState();
}

class _DetailsScreenFinState extends State<DetailsScreenFin> {
  int _selectedTag = 0;
