...
import 'package:udemy_proyect/models/lesson_ofi.dart';
import 'package:udemy_proyect/widgets/custom_video_player.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
// import 'package:video_player/video_player.dart';
import '../widgets/lesson_card_ofi.dart';

class DetailsScreenOfi extends StatefulWidget {
  final String title;
  // ignore: use_super_parameters
  const DetailsScreenOfi({
    Key? key,
    required this.title,
  }) : super(key: key);
  ...
  _DetailsScreenOfiState createState() => _DetailsScreenOfiState();
}

class _DetailsScreenOfiState extends State<DetailsScreenOfi> {
  int _selectedTag = 0;
